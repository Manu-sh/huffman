...
- HuffmanCode buffer could live into the stack since it's at most uint8_t[256] this affect memory because mostly are smaller but can produce a better performance, using a custom allocator is also a solution but introduce more complexity
